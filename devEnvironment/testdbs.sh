...
docker run -d --publish 9090:9090 --publish 5222:5222 -v openfire:/var/lib/openfire fishbowler/openfire:v4.7.0
docker run -d --publish 6379:6379 redis:6.2.6-alpine