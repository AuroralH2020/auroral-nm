...
export const sendVerificationMail = async (status: RegistrationStatus, token: string, locals: localsTypes.ILocals): Promise<void> => {
...
export const resendVerificationMail = async (status: RegistrationStatus, token: string, locals: localsTypes.ILocals): Promise<void> => {
    // For status pending token === registrationId
    const registrationId = token
    // Retrieve the registration object
    const registrationObj = await RegistrationModel._getDoc(registrationId)
...
export const declineRegistration = async (status: RegistrationStatus, token: string, locals: localsTypes.ILocals): Promise<void> => {
    // For status pending token === registrationId
    const registrationId = token
    // Retrieve the registration object
    const registrationObj = await RegistrationModel._getDoc(registrationId)
