...
type getCommunitiesController = expressTypes.Controller<{}, {}, {}, { commId: string, name: string, description: string }[], localsTypes.ILocalsGtw>
 
export const getCommunities: getCommunitiesController = async (_req, res) => {
	const { decoded } = res.locals
	try {
		if (decoded) {
			const communities = await CommunityModel._getCommunitiesByAgid(decoded.agid)
...
type getNodesInOrgController = expressTypes.Controller<{ cid: string }, {}, {}, GtwNodeInfo[], localsTypes.ILocalsGtw>
...
type getNodesInCommunityController = expressTypes.Controller<{ commId: string }, {}, {}, GtwNodeInfo[], localsTypes.ILocalsGtw>
...
type getItemsInOrganisationController = expressTypes.Controller<{  }, {}, {}, GtwItemInfo[], localsTypes.ILocalsGtw>
...
type getItemsInContractController = expressTypes.Controller<{ ctid: string, oid: string }, {}, {}, GtwItemInfo[], localsTypes.ILocalsGtw>
