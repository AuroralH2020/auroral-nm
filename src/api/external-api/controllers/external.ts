...
import { ACLObject } from '../../../persistance/externalUsers/types'
...
type checkExternalAuthController = expressTypes.Controller<{}, { keyid: string, secret: string }, {}, { ACL: ACLObject }, localsTypes.ILocals>
...
export const checkExternalAuth: checkExternalAuthController = async (req, res) => {
    const { keyid, secret } = req.body
        try {    
            ...
            return responseBuilder(HttpStatusCode.OK, res, null, { ACL: eUser.ACL })
        } catch (err) {
