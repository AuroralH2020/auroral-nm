...
// REGISTRATION
.get('/registration', jwt([RolesEnum.SUPER_USER]), addOrigin(Interfaces.UI), registrationCtrl.getAllRegistrations)
.post('/registration', addOrigin(Interfaces.UI), registrationCtrl.postRegistration)
.get('/registration/:registrationId', jwt([RolesEnum.SUPER_USER]), addOrigin(Interfaces.UI), registrationCtrl.getRegistration)
