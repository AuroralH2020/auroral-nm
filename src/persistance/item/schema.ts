...
import {
    ...
    getByOwner,
    getItemsPrivacy,
    addContractToItem, removeContractFromItem, removeContractFromCompanyItems, getAllCompanyItemsContractView, count, search, getAllCompanyItems, getBrokenItemsWithoutActiveNode
} from './statics'
...
ItemSchema.statics._getBrokenItemsWithoutActiveNode = getBrokenItemsWithoutActiveNode
